...
- [Agent Loop](core-systems/agent-loop.md)
- [Memory](core-systems/memory.md)
- [Session Indexing](core-systems/indexing.md)
- [Workstreams](core-systems/workstreams.md)
...
- [Overview](extensibility/README.md)
- [Plugin System](extensibility/plugins.md)
- [Subagent Delegation](extensibility/subagents.md)
